#ifndef __image_processing_test_sfun_h__
#define __image_processing_test_sfun_h__
...
extern mxArray* load_image_processing_test_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_image_processing_test_optimization_info(void);
